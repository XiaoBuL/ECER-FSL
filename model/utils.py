...
def postprocess_args(args):            
    ...
    args.save_path = args.save_path + args.exp_num
    return args
...
def get_command_line_parser():
    ...
    parser.add_argument('--model_class', type=str, default='MultiSem_Bfusion_Adapter', 
                        choices=['MultiSem_Bfusion_Adapter','MatchNet', 'ProtoNet', 'BILSTM', 'DeepSet', 'GCN', 'FEAT', 'FEATSTAR', 'SemiFEAT', 'SemiProtoFEAT']) # None for MatchNet or ProtoNet
    ...
    parser.add_argument('--backbone_class', type=str, default='ConvNet',
                        choices=['ConvNet', 'Res12', 'Res18', 'WRN','Visformer','Res12_ori','SwinT'])
    parser.add_argument('--dataset', type=str, default='MiniImageNet',
                        choices=['MiniImageNet', 'TieredImageNet', 'CUB','CIFAR_FS','FC100'])
    ...
    parser.add_argument('--ifentity', type=bool, default=True)

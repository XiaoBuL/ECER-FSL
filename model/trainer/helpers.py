...
from model.models.MultiSem_Bfusion_Adapter import MultiSem_Bfusion_Adapter
...
def prepare_model(args):
    ...
    if args.init_weights is not None:
        ...
        if args.backbone_class == 'SwinT':
            # pretrained_dict = {k.replace('backbone.','encoder.'): v for k, v in pretrained_dict.items() if k.replace('backbone.','encoder.') in model_dict}

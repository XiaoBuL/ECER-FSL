...
class ResNet(nn.Module):
    ...
    def __init__(self, block=BasicBlock, keep_prob=1.0, avg_pool=True, drop_rate=0.1, dropblock_size=5):
        ...
        self.avgpool3 = nn.AvgPool2d(kernel_size=10, stride=10, padding=0)
        self.avgpool2 = nn.AvgPool2d(kernel_size=21, stride=21, padding=0)  
        
        self.localout_forpretrain = None      
    ...
    def forward(self, x):
        ...
        x = self.layer2(x)
        self.layer2_out = x # self.avgpool2(x)
        x = self.layer3(x)
        self.layer3_out = x # self.avgpool3(x)
        x = self.layer4(x)
        self.layer4_out = x
        
        self.localout_forpretrain = x
        #self.localout_forpretrain = self.localout_forpretrain/self.localout_forpretrain.norm(dim=-1, keepdim=True)
